...
> **Road network:** `data/bengaluru_drive.graphml` is not committed (254 MB). On first run the app downloads and caches it automatically via OSMnx (~60 s, internet required). Subsequent runs load from disk in ~2 s.
